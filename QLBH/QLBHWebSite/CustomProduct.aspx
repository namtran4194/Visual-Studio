            ...
            <div class="auto-style4">
                <asp:FormView ID="FormView1" runat="server" DataKeyNames="Ma" DataSourceID="SqlDataSource1" DefaultMode="Insert" OnItemUpdated="FormView1_ItemUpdated">
                    ...
                    <asp:TextBox ID="GiaTextBox" runat="server" Text='<%# Bind("Gia") %>' />
                        <br />
                        NgaySX:
                    <asp:TextBox ID="NgaySXTextBox" runat="server" Text='<%# Bind("NgaySX") %>' ReadOnly="True" />
                        <ajaxToolkit:CalendarExtender ID="NgaySXTextBox_CalendarExtender" runat="server" BehaviorID="NgaySXTextBox_CalendarExtender" TargetControlID="NgaySXTextBox" />
                        <br />
